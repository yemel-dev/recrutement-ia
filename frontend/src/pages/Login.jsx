...
export default function Login() {
  ...
  // Connexion Google — GoogleLogin retourne directement un id_token (credential)
    ...
    <div className="min-h-screen flex">
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              {[
                ...
                { icon: "🎯", label: "Scoring multicritere pondere" },
                { icon: "📊", label: "Profil de personnalite Big Five OCEAN" },
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center bg-gray-50 px-6 py-12">
        <div className="w-full max-w-md">
          ...
          {/* Bouton Google — composant officiel qui retourne un id_token */}
          <div className="flex justify-center mb-5">
            <GoogleLogin
              onSuccess={handleGoogleSuccess}
              onError={() => setError("La connexion Google a echoue. Reessaie.")}
              text="signin_with"
              shape="rectangular"
              logo_alignment="left"
              width="400"
