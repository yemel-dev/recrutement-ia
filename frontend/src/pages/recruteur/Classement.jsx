...
export default function Classement() {
  ...
  const [tri, setTri] = useState("score_global"); // score_global | score_competences | score_experience | score_formation | score_personnalite
  ...
  // ── Application des filtres + tri (recalculé seulement si une dépendance change) ──
