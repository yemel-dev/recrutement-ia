  ...
  useEffect(() => {
    api.get(`/offers/${offreId}`)
      .then((res) => {
        ...
        setOcean({ ocean_O: o.ocean_O ?? 0.5, ocean_C: o.ocean_C ?? 0.5, ocean_E: o.ocean_E ?? 0.5, ocean_A: o.ocean_A ?? 0.5, ocean_N: o.ocean_N ?? 0.5 });
        setPoids({ poids_competences: o.poids_competences ?? 0.40, poids_experience: o.poids_experience ?? 0.25, poids_formation: o.poids_formation ?? 0.20, poids_personnalite: o.poids_personnalite ?? 0.15 });
      })
