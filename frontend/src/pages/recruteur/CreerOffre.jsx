...
export default function CreerOffre() {
  ...
  const [ocean, setOcean] = useState({
    ocean_O: 0.7, ocean_C: 0.8, ocean_E: 0.5, ocean_A: 0.6, ocean_N: 0.3,
  });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(err.response?.data?.detail || "Impossible de creer l'offre.");
    } finally {
      setSubmitting(false);
    }
  };
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-xl font-extrabold text-gray-900">Creer une offre d'emploi</h1>
          <p className="text-xs text-gray-400 mt-0.5">
            Configurez les criteres de selection et le profil de personnalite ideal
          </p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 space-y-5">
          ...
          <div className="space-y-1.5">
            ...
            <input
              type="text"
              placeholder="ex: Developpeur Python Senior"
              value={titre}
          ...
          <div className="space-y-1.5">
            ...
            <textarea
              rows={4}
              placeholder="Decrivez les missions, le contexte, les attentes..."
              value={description}
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 space-y-4">
          <div className="pb-3 border-b border-gray-50">
            ...
            <p className="text-xs text-gray-400 mt-0.5">Fourchette annuelle brute (FCFA ou devise locale)</p>
          </div>
          <div className="grid sm:grid-cols-2 gap-5">
            <div className="space-y-1.5">
